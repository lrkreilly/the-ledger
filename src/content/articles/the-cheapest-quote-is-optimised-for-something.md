...
That is why the first job of a quote is not to give a number. It is to show what the painter thinks the scope is.
...
*Priced for the brief.* The cheap quote prices the job as described, and nothing more. Anything outside the brief becomes a variation: a surface that needs more prep, a surface that doesn't take the finish, a section that takes longer than estimated, materials that cost more than expected. On a job where everything goes to plan, the buyer pays the original quote and nothing more. On a job where it does not, the total can climb past what a quote with a built-in buffer would have cost from the start. The trade-off: the buyer avoids paying for problems that may never happen, but carries more of the cost if they do.
...
*Standards and finish.* The expensive quote often prices a more thorough job: more careful prep, better materials, a more experienced crew, higher finish throughout. For a buyer who wants the job done to a high standard and will notice the difference, this is exactly what they're paying for. For a buyer whose project doesn't call for that level of finish, it's spec they may not need.

*Margin to hold a standard.* The operator has the financial room to slow down when the job needs it, redo what didn't land right, or put the experienced person on the awkward part. Buyers who need that flexibility get real value from it. Buyers whose job goes smoothly from start to finish are paying for flexibility the operator never needed to use.

*Buffer for the unexpected.* Some expensive quotes carry a small contingency to absorb things that go differently than planned: a surface that doesn't take the finish, a section that takes longer than estimated, materials that cost more than expected. The trade-off is cost certainty against paying for cover that may not be needed. Buyers who would rather pay only if something happens often prefer quotes without a built-in buffer. Buyers who want one final number may prefer paying for that certainty upfront.

*Warranty cover.* Some of the price is the cost of standing behind the work after it's done. If something fails within the warranty period, the operator has already factored it in. For a buyer who values that backstop, it's real protection. For a buyer who would handle any issue themselves anyway, it's cover they may not use.

*Follow-up access.* Part of the price buys ongoing accountability: a follow-up visit to make sure the work is holding up, a check-in on how the result is settling in, and the same operator picking up the phone for the next thing. Worth a lot to a buyer who will have more work over time or who wants the operator to stand behind the result. Worth little to a one-off buyer who would handle any follow-up themselves.
...
*What happens if the job is harder than expected?* The answer is where most cheap quotes turn out to be more expensive than they looked, and where some expensive quotes turn out to be worth their price. The buyer wants to know who absorbs the surprise.
...
*How is a problem handled after the job is done?* The cheapest quote and the most expensive quote often answer this question very differently. The middle quote often hasn't been asked.

## What the buyer is actually deciding

The decision in front of a buyer comparing three quotes is rarely the decision the prices suggest. It is not "which one is fair." It is closer to: which set of assumptions about scope, surprise, follow-up, and accountability matches the job that actually needs doing, and the buyer doing the hiring.

Sometimes the cheap quote is the right answer because the job is simple, the consequences are small, and the buyer is comfortable managing the work. Sometimes the expensive quote is the right answer because the job is complex, the consequences of getting it wrong are large, and the buyer has neither the time nor the appetite to absorb surprises. Sometimes the middle quote is the right answer for reasons that have nothing to do with being a sensible compromise.

Compare the prices last. Compare the job each price is built to describe, first.
